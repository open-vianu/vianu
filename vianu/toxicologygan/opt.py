...
def parse_opt():
    ...
    parser.add_argument("--data_path", type=str, default='./dummy_data/Example_Data_training.tsv',
                        help="path to file that stores all the training data")
    parser.add_argument("--descriptors_path", type=str, default='./dummy_data/Example_MolecularDescriptors.tsv',
