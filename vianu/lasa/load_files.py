...
def extract_drug_name(text):
    ...
    result_words = [
        word for word in words_within_medicament if word.lower() not in stopwords
    ]
...
def read_medicament_file_as_list(chosen_sources: List):
    """
    read_medicament_file reads files from any of the four sources ['dummy', 'fda','rxnorm','usan','swissmedic']

    Input:
    chosen_sources: List with any number out of the possible sources ['dummy', 'fda','rxnorm','usan','swissmedic']
