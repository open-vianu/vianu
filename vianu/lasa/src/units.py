...
class SwissmedicAuthorization(AuthorizationUnit):
    ...
    _source_url: ClassVar[str] = 'https://www.swissmedic.ch/swissmedic/en/home/services/listen_neu.html'
...
class FDAAuthorization(AuthorizationUnit):
    ...
    _source_url: ClassVar[str] = 'https://www.fda.gov/drugs/drug-approvals-and-databases/drugsfda-data-files'
...
class AuthorizationFactory:
    ...
    def create(cls, source: str) -> AuthorizationUnit:
        ...
        return authorization.from_file(filename=cls._FILE_PATH / cls._FILE_NAME_MAP[source])
